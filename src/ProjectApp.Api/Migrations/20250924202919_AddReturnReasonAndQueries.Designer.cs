...
namespace ProjectApp.Api.Migrations
{
    ...
    [Migration("20250924202919_AddReturnReasonAndQueries")]
    partial class AddReturnReasonAndQueries
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectApp.Api.Models.ReturnItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ProjectApp.Api.Models.ReturnItem", b =>
                {
                    b.HasOne("ProjectApp.Api.Models.Return", "Return")
                        .WithMany("Items")
                        .HasForeignKey("ReturnId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProjectApp.Api.Models.SaleItem", "SaleItem")
                        .WithMany()
